...
from FitNice_bot.buttons import main_button, start_button, woman_button, man_button, hafta_button
from dotenv import load_dotenv
from aiogram.fsm.state import StatesGroup, State

load_dotenv()
TOKEN = getenv('TOKEN_FOR_FITNICE')
...
async def command_start_handler(message: Message, ) -> None:
    ...
    await message.answer_photo(photo='https://telegra.ph/file/607b1aa4d011224284803.png',
...
async def start_button_handler(message: Message, state: FSMContext) -> None:
    if message.text == 'Woman 🧍‍♀️':
        ...
        await message.answer_photo(photo='https://telegra.ph/file/51a52f9a0ac810bbb2c78.png',
                                   caption=caption, reply_markup=woman_button())
        await state.set_state(StepState.woman_state)

    elif message.text == 'Men 🧍‍♂️':
        caption = ('Quydagilarni birontasini tanlang 👇🏿')
        await message.answer_photo(photo='https://telegra.ph/file/35794f12e932f79d20aa5.png',
